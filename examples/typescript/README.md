...
This directory contains a collection of TypeScript examples demonstrating how to use the X402 protocol in various contexts across EVM (Ethereum), SVM (Solana), and AVM (Algorand) networks. These examples are designed to work with the X402 npm packages and share a workspace with the main X402 packages.
...
For Algorand, you can generate a wallet using [goal](https://developer.algorand.org/docs/clis/goal/) or the [AlgoKit CLI](https://github.com/algorandfoundation/algokit-cli), and fund it via the [Algorand Testnet Dispenser](https://bank.testnet.algorand.network/).
