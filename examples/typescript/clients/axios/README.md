...
Example client demonstrating how to use `@x402-avm/axios` to make HTTP requests to endpoints protected by the x402 payment protocol. Supports EVM (Ethereum), SVM (Solana), and AVM (Algorand) networks.
