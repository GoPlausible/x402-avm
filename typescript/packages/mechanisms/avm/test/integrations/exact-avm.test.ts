...
describe('AVM Integration Tests', () => {
  describe('x402Client / x402ResourceServer / x402Facilitator - AVM Flow', () => {
    ...
    it('server should successfully verify and settle an AVM payment from a client', async () => {
  ...
  describe('x402HTTPClient / x402HTTPResourceServer / x402Facilitator - AVM Flow', () => {
    ...
    it('middleware should successfully verify and settle an AVM payment from an http client', async () => {
