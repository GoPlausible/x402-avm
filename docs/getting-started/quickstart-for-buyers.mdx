...
<Tabs>
  <Tab title="Node.js">
    ...
    npm install @x402-avm/fetch @x402-avm/evm
...
<Tabs>
  <Tab title="Fetch">
    **@x402-avm/fetch** extends the native `fetch` API to handle 402 responses and payment headers for you. [Full example here](https://github.com/coinbase/x402/tree/main/examples/typescript/clients/fetch)
  ...
  <Tab title="Axios">
    **@x402-avm/axios** adds a payment interceptor to Axios, so your requests are retried with payment headers automatically. [Full example here](https://github.com/coinbase/x402/tree/main/examples/typescript/clients/axios)
...
- Install x402 client packages (`@x402-avm/fetch` or `@x402-avm/axios`) and mechanism packages (`@x402-avm/evm`, `@x402-avm/svm`)
...
- [@x402-avm/evm on npm](https://www.npmjs.com/package/@x402-avm/evm)
