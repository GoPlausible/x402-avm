...
<Tabs>
  <Tab title="Express">
    Install the [x402 Express middleware package](https://www.npmjs.com/package/@x402-avm/express).
  ...
  <Tab title="Next.js">
    Install the [x402 Next.js middleware package](https://www.npmjs.com/package/@x402-avm/next).

    ```bash
    npm install @x402-avm/next @x402-avm/core @x402-avm/evm
    ```

  </Tab>
  <Tab title="Hono">
    Install the [x402 Hono middleware package](https://www.npmjs.com/package/@x402-avm/hono).

    ```bash
    npm install @x402-avm/hono @x402-avm/core @x402-avm/evm
    ```
